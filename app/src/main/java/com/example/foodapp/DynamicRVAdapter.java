...
public class DynamicRVAdapter extends RecyclerView.Adapter<DynamicRVAdapter.DynamicRvHolder>{
    ...
    public ArrayList<DinamicRVModel> dinamicRVModels;
    ...
    public DynamicRVAdapter(ArrayList<DinamicRVModel> dinamicRVModels){
        this.dinamicRVModels = dinamicRVModels;
    }
    ...
    public DynamicRVAdapter.DynamicRvHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.dinamic_rv_item_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull DynamicRVAdapter.DynamicRvHolder holder, int position) {
        DinamicRVModel currentItem = dinamicRVModels.get(position);
